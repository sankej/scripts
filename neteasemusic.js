...
const $ = new Env('网易云音乐')
$.VAL_session = process.env['chavy_cookie_neteasemusic']
$.CFG_retryCnt = (process.env['CFG_neteasemusic_retryCnt'] || '10') * 1
$.CFG_retryInterval = (process.env['CFG_neteasemusic_retryInterval'] || '500') * 1
