...
$.VAL_signhomeurl = process.env['chavy_signhomeurl_wps']
$.VAL_signhomeheader = process.env['chavy_signhomeheader_wps']
$.CFG_inviteWaitTime = process.env['CFG_wps_inviteTime'] * 1 || 2000 // 每次并发间隔时间 (毫秒)
